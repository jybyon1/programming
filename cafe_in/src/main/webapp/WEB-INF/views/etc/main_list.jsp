...
<!-- this page -->
<link rel="stylesheet" href="${ pageContext.request.contextPath }/resources/_css/main_list.css">
...
<body>
	...
	<div class="tp_layer">
		<div class="tp_index_layout">
			...
			<div class="c_layout" >	
				<c:forEach  var="vo"   items="${ list }" begin="1" end="10" > 	            
		            <div class="cafe_list" onclick="location.href='../detail/detail_list.do?c_idx=${vo.c_idx}'">
