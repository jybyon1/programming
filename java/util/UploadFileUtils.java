...
public class UploadFileUtils {
	 ...
	 * Calendar cal = Calendar.getInstance();
	 * 
	 * String yearPath = cal.get(Calendar.YEAR) + "_";
	 * 
	 * String monthPath = yearPath + new
	 * DecimalFormat("00").format(cal.get(Calendar.MONTH) + 1) + "_";
	 * 
	 * String datePath = monthPath + new
	 * DecimalFormat("00").format(cal.get(Calendar.DATE))+"_";
	 * 
	 * // makeDir(uploadPath, yearPath, monthPath, datePath);
	 * 
	 * logger.info(datePath);
